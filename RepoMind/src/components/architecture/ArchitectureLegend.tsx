...
const NODE_TYPES = [
  { type: "api_route", label: "API Route", color: "#3b82f6" },
  { type: "component", label: "Component", color: "#8b5cf6" },
  { type: "service", label: "Service", color: "#10b981" },
  { type: "utility", label: "Utility", color: "#f59e0b" },
  { type: "database", label: "Database", color: "#ef4444" },
  { type: "external_dependency", label: "External", color: "#6b7280" },
];

const EDGE_TYPES = [
  { type: "imports", label: "Imports", color: "#94a3b8", dash: "" },
  { type: "depends_on", label: "Depends On", color: "#f59e0b", dash: "5,5" },
